    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.stories.jsx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.jsx)$"}];</script><script src="runtime~main.3d7a7246.iframe.bundle.js"></script><script src="vendors~main.4b261a22.iframe.bundle.js"></script><script src="main.7e6d3a93.iframe.bundle.js"></script></body></html>
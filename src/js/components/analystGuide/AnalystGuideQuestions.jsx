...
const AnalystGuideQuestions = ({ onExternalLinkClick }) => {
    ...
    {
        question: "Which fields in download files contain prime award summary identifier information?",
        answer: (<>
            ...
            <p className="analyst-guide__answerStyle">More information on how to download more data is available in the{' '}
                <button
                    role="link"
                    className="analyst-guide__sectionJump"
    ...
    {
        question: "Which fields in download files contain award type information?",
        answer: (<>
            ...
            <p className="analyst-guide__answerStyle">More information about these fields is available in the <Link to="/data-dictionary">Data Dictionary</Link> and the <a href="https://files.usaspending.gov/docs/Custom+Account+Data+Dictionary.xlsx">Custom Account Data Dictionary</a>.</p>
            <p className="analyst-guide__answerStyle">More information on how to download additional data is available in the{' '}
                <button
                    role="link"
                    className="analyst-guide__sectionJump"
                    onClick={() => jumpToSection("analyst-guide__DataAccess")}>
    ...
    {
        question: "Which fields in download files contain award spending amount information?",
        answer: (<>
            ...
            <p className="analyst-guide__answerStyle">More information about these fields is available in the <Link to="/data-dictionary">Data Dictionary</Link> and the <a href="https://files.usaspending.gov/docs/Custom+Account+Data+Dictionary.xlsx">Custom Account Data Dictionary</a>.</p>
            <p className="analyst-guide__answerStyle">More information on how to download data is available in the{' '}
                <button
                    role="link"
                    className="analyst-guide__sectionJump"
                    onClick={() => jumpToSection("analyst-guide__DataAccess")}>
    ...
    },
    {
        ...
        answer: (<>
            <p className="analyst-guide__answerStyle">Currently, it’s uncommon for agencies to update loans with corrections to the base record or by adding a modification record. As a result, the face value and subsidy cost data  generally only reflect the reality at the time of initial reporting. If the face value of the loan is modified during its life (such as if the loan principal is later expanded or the recipient returns part of the original loan), this will generally not be reflected in the data. If the risk profile of a recipient changes, up to and including if they completely default on the loan, this will generally not be reflected in the data. If the loan is forgiven, this will generally not be reflected in the data either. Consequently, loan spending data are generally less accurate than that of other award types.</p>
        </>)
    },
    {
        question: "Which fields in download files contain loan value information?",
        answer: (<>

        ...
        <div className="dsm__container">
            ...
            <div className="dsm__topSection">
                ...
                {publicLaw === 'american-rescue-plan' ?
                    <div />
                    :
                    <p>USAspending is working with federal agencies to address known limitations in COVID-19 spending data. See a <a href="data/data-limitations.pdf" rel="noopener noreferrer">full description</a> of this issue.</p>
                }
            </div>
        </div>
    </div>

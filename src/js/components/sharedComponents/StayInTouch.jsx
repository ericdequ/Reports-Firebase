                ...
                <FlexGridRow className="stay-in-touch__container-row" hasGutter gutterSize="lg">
                    ...
                    <FlexGridCol
                        ...
                        <div className="stay-in-touch__second-row-title">
                                Signup to be alerted for the offical release of The Bread GETTER
                        </div>
                        <div className="stay-in-touch__second-row-text">
                                Sign up to receive our release notes to keep up with Government Spending
                        </div>
                    ...
                    <FlexGridCol
                        ...
                        tablet={6}>
                        <div className="stay-in-touch__second-row-title">
                                Search Ongoing Government awards and track them throughout the procurement process
                        </div>
                        <div className="stay-in-touch__second-row-text">
                                Sign up to get alerts on new contracts and spending trends
                        </div>
                        <div className="stay-in-touch__second-row-link">
